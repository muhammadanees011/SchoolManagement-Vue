    ...
    <div class="row">
      <div class="col-12">
        <div class="card px-1">
          ...
          <span class="ps-3">
            <small class="page-description">Here, you can add organizations such as ETC. Each organization can have multiple sites associated with it, all belonging to the same organization.</small>
          </span>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-xxs font-weight-bolder"> Organisation Name </th>
                ...
                <tbody>
                  <tr v-if="organizationsData.length === 0">
