                ...
                <div class="card-body pt-4 p-3">
                    <div class="row">
                        <ul class="list-group col-xl-6 col-lg-6 col-md-6">
                            <template v-for="(item,index) in cartItems" :key="index">
                                <li v-if="item.shop_item!==null" class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                    ...
                                    <h6 class="mb-3 text-sm">{{ item.shop_item.name }} (Shop Item)</h6>
                        ...
                        <div class="col-md-5 ms-auto">
                            ...
                            <button v-if="cartItems.length>0" @click="checkout()" style="font-size: 12px; background-color: #573078;" class="mt-3 me-3 trips-btn w-45 bg-gradient-grey shadow-grey text-white fw-5 p-2 border-radius-lg"> One-Click Payment </button>
                            </template>
                        </div>
                    </div>
                </div>
